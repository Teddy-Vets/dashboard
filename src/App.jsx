...
const PUBLIC_PATHS = ['/PublicForm', '/PublicConsentForm', '/PublicViewIntakeForm', '/AppointmentBooking', '/PublicAnxietyQuestionnaire', '/PublicEmergencyTriage', '/PublicSubscriptionAgreement'];
...
const AuthenticatedApp = () => {
  ...
  // Skip auth checks for public pages — clients opening form links should not be asked to log in
  if (!isPublicPath) {
