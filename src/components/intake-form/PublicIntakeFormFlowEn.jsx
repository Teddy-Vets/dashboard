...
import PersonalInfoStepEn from "./PersonalInfoStepEn";
import PetInfoStepEn from "./PetInfoStepEn";
import MedicalHistoryStepEn from "./MedicalHistoryStepEn";
import VisitInfoStepEn from "./VisitInfoStepEn";
import ReviewStepEn from "./ReviewStepEn";

import { submitIntake } from "@/functions/submitIntake";

const STEPS = [
  { id: 1, title: "Personal Info", component: PersonalInfoStepEn },
  { id: 2, title: "Pet Information", component: PetInfoStepEn },
  { id: 3, title: "Medical History", component: MedicalHistoryStepEn },
  { id: 4, title: "Visit Information", component: VisitInfoStepEn },
  { id: 5, title: "Review & Submit", component: ReviewStepEn }
];

export default function PublicIntakeFormFlowEn({ token, formId, initialData = {} }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('[PublicIntakeFormFlowEn] Submitting with formId:', formId);
      ...
      if (response.data && response.data.success) {
        ...
        throw new Error(response.data?.error || "Error submitting form");
      }
    } catch (error) {
      console.error("[PublicIntakeFormFlowEn] Error submitting intake form:", error);
            ...
            <CardContent className="p-12 text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  Thank you for filling out the intake form.<br />
                  A clinic representative will contact you shortly.
                </p>
              </div>

              <div className="bg-gradient-to-r from-blue-50 to-teal-50 p-6 rounded-lg border-2 border-blue-200">
                <p className="text-slate-700 font-medium">
                  We've saved all the information you provided and will take the best care of you! 💙
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex-1 text-center text-white px-8 md:px-16">
              <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 drop-shadow-lg max-w-2xl mx-auto">
                Welcome, we're already looking forward to meeting you
              </h1>

              <p className="text-xs md:text-sm lg:text-base max-w-2xl mx-auto leading-tight drop-shadow-md">
                The intake process is quick and will help us prepare a pleasant and personalized visit for you and your pet
              </p>
            </div>
