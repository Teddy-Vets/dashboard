        ...
        <section className="mb-6">
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 text-sm">
            ...
            <p className="text-slate-600 mt-1">
              תשלום: <span className="font-semibold">{agreement.payment_frequency === 'monthly' ? 'הוראת קבע חודשית' : agreement.payment_frequency === 'annual' ? 'שנתי מראש חד-פעמי (כולל חודש מתנה)' : 'שנתי מתחדש (כולל חודש מתנה)'}</span>
            </p>
          </div>
        </section>
